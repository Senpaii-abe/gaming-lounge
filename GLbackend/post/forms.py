...
class EditPostForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['game_title'].queryset = GameTitle.objects.all()  # Set the queryset for the game_title field
        self.fields['game_title'].widget = forms.Select(choices=GameTitle.objects.all().values_list('id', 'title'))
