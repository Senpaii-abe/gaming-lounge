<template>
					...
					<div class="flex items-center justify-between">
						...
						<!-- right menu icons start -->
								<div class="menu-right flex space-x-2">
									...
									<!-- <a href="#"><img src="https://i.pravatar.cc/40" class="rounded-full"></a> -->
								</div>   
					</div>
			</div>
		</nav>
	...
	<!-- main view-->
		<main class="flex justify-center items-center flex-wrap px-8 py-6 bg-fixed md:bg-fixed bg-cover bg-[url('../assets/img/bg/bg-1.svg')]"> 
			<RouterView /> 
		</main>
